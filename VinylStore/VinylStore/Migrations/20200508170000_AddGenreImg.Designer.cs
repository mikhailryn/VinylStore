...
namespace VinylStore.Migrations
{
    ...
    [Migration("20200508170000_AddGenreImg")]
    partial class AddGenreImg
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VinylStore.Models.Album", b =>
                {
            ...
            modelBuilder.Entity("VinylStore.Models.Artist", b =>
                {
                    b.Property<int>("ArtistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImgUrl = "https://life.bodo.ua/upload/files/cm-event/17/16666/image/971226c05f8108a4375440fad6ebd5d788edcf12-r1r1h1000w1422zc3q100.jpg"
                        },
                        new
                        {
                            ArtistId = 2,
                            ArtistName = "Madonna",
                            ImgUrl = "https://imgclf.112.ua/original/2019/05/15/388283.jpg?timestamp=1557857653"
                        },
                        new
                        {
                            ArtistId = 3,
                            ArtistName = "Stevie Wonder",
                            ImgUrl = "https://tunnel.ru/media/images/2019-05/post/128729/stevie-wonder-1.jpg"
                        });
                });
            ...
            modelBuilder.Entity("VinylStore.Models.Genre", b =>
                {
                    b.Property<int>("GenreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VinylStore.Models.Album", b =>
                {
                    b.HasOne("VinylStore.Models.Artist", "Artist")
                        .WithMany("Albums")
                        .HasForeignKey("ArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VinylStore.Models.Genre", "Genre")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("VinylStore.Models.Vinyl", b =>
                {
                    b.HasOne("VinylStore.Models.Album", "Album")
                        .WithMany("Vinyls")
